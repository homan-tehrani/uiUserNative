        ...
        <div className="w-full lg:bg-white  lg:border  lg:border-stone-300 rounded-xl py-8 px-6 h-max  flex flex-col">
          <div className="w-full flex flex-col items-center gap-y-4 border-b border-stone-300 h-28 ">
            <div className="flex items-center justify-center">
              <svg
                ...
                className="w-10 fill-cyan-600"
                viewBox="0 0 24 24"
              >
                <path d="M5 11V13H19V11H5Z"></path>
              </svg>
              <h2 className="xs:text-base text-xl">
                مشخصات محل برگزاری
              </h2>
            </div>
          ...
          <form className="w-full h-max   flex flex-col  ">
            <div className="w-full  h-max flex flex-col gap-y-4 lg:flex-row items-center justify-center sm:gap-x-6 py-5">
              <fieldset
                className={`${
                  state.isShowNameActive
                    ? 'border-cyan-600'
                    : 'border-stone-300 '
                } border-2 opacity-70 flex items-center justify-center text-[12px] xs:h-12 h-16  pr-3 rounded-xl w-full lg:w-1/2`}
              >
                <legend className=" xs:text-[12px] text-base px-2">
                  نام و نام خانوادگی
                </legend>
                <input
                  onFocus={() =>
                    dispatch({ type: 'ACTIV_INPUTNAME' })
                  }
              ...
              >
                ...
                <input
                  onFocus={() =>
                    dispatch({ type: 'ACTIVE_INPUTEMAIL' })
                  }
                  className="w-full outline-0 h-full rounded-xl bg-inherit"
                  type="email"
                />
            ...
            <div className="w-full h-max mt-4 flex flex-col gap-y-10  items-end justify-center">
              <textarea
                onFocus={() => dispatch({ type: 'ACTIVE_TEXTAREA' })}
                className={` ${
                  state.isShowTextArea
                    ? 'border-cyan-600'
                    : 'border-stone-300'
                } border-2 h-52 w-full pr-4 pt-2 rounded-xl resize-none outline-none `}
              ></textarea>
              <div className="w-full xs:h-12 h-16 bg-netral-100 border-2 hover:bg-neutral-100 border-stone-300 rounded-lg flex items-center justify-between px-4">
                <div className="">
                  <p className="opacity-70 xs:text-[12px] text-base">
                    ۱. فایل متنی آشنایی با اقتصاد
                  </p>
                </div>
                <div className="h-full flex items-center justify-center gap-x-1 sm:gap-x-12 ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    className="fill-stone-500 xs:w-4 w-6 cursor-pointer"
                  >
              ...
              <div className="w-full xs:h-12 h-16 bg-netral-100 border-2 hover:bg-neutral-100 border-stone-300 rounded-lg flex items-center justify-between px-4">
                <div className="flex justify-center items-center gap-x-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    className="xs:w-4 w-6 opacity-70"
                  >
                ...
                <div className="h-full  w-24 flex items-center justify-center  ">
                  <button className="w-full h-3/4 xs:-translate-x-3 xs:text-[12px] text-base translate-x-0  bg-cyan-600 rounded-md text-white">
                    انتخاب فایل
                  </button>
                </div>
              </div>
              <button className="xs:h-12 xs:text-[12px] text-base w-36 h-16 rounded-md bg-cyan-600 text-white ">
                ارسال تیکت
              </button>
            </div>
          </form>
