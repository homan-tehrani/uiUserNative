  ...
  return (
    <div className="w-full h-max bg-neutral-100 pt-8 sm:pt-16 pb-32">
        ...
        <div className="bg-white pb-8 px-4 sm:px-6 h-max flex flex-col gap-y-6 sm:border border-stone-300  sm:rounded-xl leading-7 sm:leading-8 text-sm sm:text-base">
          <div className="w-full  h-max flex flex-col items-center gap-y-3 pt-12">
            <div className="flex items-center">
              <svg
                ...
                className="xs:w-5 w-10 fill-cyan-700"
                viewBox="0 0 24 24"
              >
                <path d="M5 11V13H19V11H5Z"></path>
              </svg>
              <h1 className="xs:text-sm text-xl font-bold">
                دریافت اطلاعات مجموعه درخواست کننده
              </h1>
            </div>
            <p className="xs:text-[12px]">
              لطفا پیش از ارسال ایمیل یا تماس تلفنی، ابتدا{' '}
              <span className="text-cyan-600">قوانین</span> را مشاهده
              کنید.
            </p>
          </div>
            ...
            <div className="w-full sm:w-[280px] md:w-[340px] lg:w-[470px] xl:w-[600px] 2xl:w-[720px] h-max  flex flex-col ">
              <div className="w-full  h-14 border-2 border-stone-300 rounded-xl flex items-center justify-between cursor-pointer px-2">
                <select
                  ...
                  className="w-full outline-none bg-inherit cursor-pointer h-full"
                  name=""
                  id=""
                >
          ...
          <div className="w-full h-max  flex flex-col gap-y-6 sm:gap-y-0   sm:flex-row justify-center gap-x-3 items-center flex-wrap">
            <div className="w-full sm:w-[280px] md:w-[340px] lg:w-[470px] xl:w-[600px] 2xl:w-[720px] h-max  flex flex-col ">
              <div className="w-full  h-14 border-2 border-stone-300 rounded-xl flex items-center justify-between cursor-pointer px-2">
                <select
                  onChange={handleReguestingOrganChange}
                  className="w-full outline-none bg-inherit cursor-pointer h-full"
                  name=""
                  id=""
                >
          ...
          <div className="w-full h-max  flex flex-col gap-y-6   sm:flex-row justify-start gap-x-3 items-center flex-wrap">
            <InputForTeacherInvitation
              content="ایمیل مجموعه"
              type="email"
            />
            <InputForTeacherInvitation
              content="نشانی صفحه مجازی"
              type="text"
            />
            <InputForTeacherInvitation
              content="شماره تماس مجموعه"
              type="tel"
            />
          </div>
        </div>
          ...
          <div className=" w-full   h-max py-10 border-stone-300  flex flex-col">
            <div className="w-full h-max flex flex-col items-center gap-y-3 mb-8">
              <div className="flex items-center justify-center ">
                ...
                <h2 className="xs:text-sm  text-xl font-bold">
                  مشخصات محل برگزاری
                </h2>
              </div>
              <p className="xs:text-[10px]">
                لطفا پیش از ارسال ایمیل و تماس تلفنی،ابتدا{' '}
                <span className="text-cyan-600">قوانین</span> را
                مشاهده کنید.
              </p>
            </div>
            ...
            <div className="w-full  h-max  flex flex-col gap-y-6 sm:gap-y-0  sm:flex-row justify-center gap-x-3 items-center flex-wrap">
              <InputForTeacherInvitation
                content="نام مکان برگزاری همایش"
                type="text"
              />
              <SelectOptionForTeacherInvite
                items={states}
                content="ظرفیت دقیق محل پیشنهادی"
              />
              <textarea
                onBlur={() => setFoucosTextArea(false)}
                onFocus={() => setFoucosTextArea(true)}
                className={` ${
                  foucosTextArea
                    ? 'border-cyan-600'
                    : 'border-stone-300'
                } resize-none w-full sm:w-[570px] md:w-[692px] lg:w-[950px] xl:w-[1212px] h-52 border-2 rounded-xl mt-4 pr-4 outline-0 pt-2" `}
              ></textarea>
            </div>
          </div>
        </div>
          ...
          <div className=" w-full   h-max py-10 border-stone-300  flex flex-col">
            <div className="w-full h-max flex flex-col items-center gap-y-3 mb-8 ">
              <div className="flex items-center justify-center ">
                ...
                <h2 className="xs:text-sm text-xl font-bold">
                  مشخصات برنامه درخواستی به ترتیب اولویت
                </h2>
              </div>
              <p className="xs:text-[10px]">
                لطفا پیش از ارسال ایمیل و تماس تلفنی،ابتدا{' '}
            ...
            <div className="w-full px-4  flex  h-max ">
              <div className="w-full  h-max  flex   gap-y-3  flex-row justify-start gap-x-3 items-center flex-wrap">
                ...
                <div className="flex flex-col w-full items-start gap-y-4 xs:text-[10px]  ">
                  <p className="font-bold xs:text-[12px] pt-8">
                    تاریخ پیشنهادی یا بازه زمانی
                  </p>

                  <div className="flex items-center flex-wrap gap-y-5 justify-start gap-x-8 sm:gap-x-12">
                    <RadioButtonForTeacherInvitation
                      xsWidth="xs:w-[140px]"
                      width="w-[150px]"
                      id="ra-1"
                      name={'Participant-range'}
                  ...
                  <div className=" mt-4 h-max w-max flex items-center xs:gap-x-3  gap-x-8 xs:text-[10px]">
                    <div className="flex items-center justify-center xs:gap-x-2 gap-x-3 h-max">
                      ...
                      <input
                        type="date"
                        value="1400-01-01"
                        className="h-12 xs:w-20 xs:h-8 border border-stone-300 rounded-xl"
                      />
                    </div>
                    <div className="flex items-center justify-center xs:gap-x-2 gap-x-3 h-max">
                      <p>تا تاریخ</p>
      ...
      <div className="container h-max mx-auto flex justify-center items-center ">
        <button className="xs:w-32 xs:h-12 xs:text-sm w-40 h-16 bg-cyan-600 text-white font-bold rounded-xl">
          دعوت از استاد
        </button>
      </div>
    </div>
