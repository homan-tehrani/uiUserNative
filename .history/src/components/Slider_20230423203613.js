...
export default function Slider() {
  ...
  return (
    <div className="container mx-auto w-full h-full  py-7 px-2">
      <Swiper
        wrapperClass="w-full"
        modules={[Navigation, Pagination, Scrollbar, A11y, EffectFade, Pagination]}
        spaceBetween="auto"
        loop={true}
        autoplay={{
          delay: 1000,
        ...
        slidesPerView={1}
        effect="fade"
        className="slider-master max-h-[32rem] min-h-full rounded-3xl overflow-hidden"
      >
        ...
        <div
          className="swiper-button-prev !text-white mx-8 after:!text-4xl"
        ></div>
        <div
          className="swiper-button-next !text-white mx-8 after:!text-4xl"
        ></div>
