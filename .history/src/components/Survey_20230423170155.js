...
<div className="xs:w-full w-full md:w-1/3 py-4 sm:h-28 bg-green-50  border border-green-500 rounded-md  flex items-center  cursor-pointer p-2">
    <svg width="127" className="stroke-current" height="128" viewBox="0 0 127 128" fill="none" xmlns="http://www.w3.org/2000/svg">
