  ...
  return (
    <div className='bg-neutral-100 flex  h-max py-10 w-full mt-4'>
      <aside className='w-4/12 h-full -translate-x-5 flex flex-col items-center gap-y-6 '>
        ...
        <div className='w-72 h-370px  border rounded-xl bg-white'>
          <div className='w-full h-20  border-b flex items-center justify-start pr-6 gap-x-2 '>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M20 4V16H23L19 21L15 16H18V4H20ZM12 18V20H3V18H12ZM14 11V13H3V11H14ZM14 4V6H3V4H14Z" fill="#000"></path></svg>
          <p>مرتب سازی</p>
          </div>
        ...
        <div className='w-72 border h-36 bg-white rounded-xl flex flex-col items-center justify-center gap-y-4'>
            <p className='text-right  w-10/12 font-bold'>جستجو بر اساس کلید واژه</p>
            <div className='w-10/12 h-12  flex items-center border rounded-lg'>
            <svg xmlns="http://www.w3.org/2000/svg" className='mr-2 opacity-60' viewBox="0 0 24 24" width="24" height="24"><path d="M18.031 16.6168L22.3137 20.8995L20.8995 22.3137L16.6168 18.031C15.0769 19.263 13.124 20 11 20C6.032 20 2 15.968 2 11C2 6.032 6.032 2 11 2C15.968 2 20 6.032 20 11C20 13.124 19.263 15.0769 18.031 16.6168ZM16.0247 15.8748C17.2475 14.6146 18 12.8956 18 11C18 7.1325 14.8675 4 11 4C7.1325 4 4 7.1325 4 11C4 14.8675 7.1325 18 11 18C12.8956 18 14.6146 17.2475 15.8748 16.0247L16.0247 15.8748Z" fill="#000"></path></svg>
            <input placeholder='جستجو کلمه' type="text" className='w-11/12 h-full outline-0 pr-2 rounded-lg '/>
            </div>
        </div>
        ...
        <div className='w-72 border h-48 bg-white rounded-xl flex flex-col items-center justify-center  '>
            ...
            <div className='flex flex-col items-center justify-center  w-full h-full gap-y-2  h-2/4'>
              ...
              <p className='pl-4 flex items-center justify-center opacity-60'>از تاریخ</p>
            <input type="text" className='border h-full w-8/12 rounded-lg outline-0 pr-2' />
              </div>
              <div className='flex items-cenetr justify-center h-12 '>
              <p className='pl-4 flex items-center justify-center opacity-60'>تا تاریخ</p>
            <input type="text" className='border h-full w-8/12 rounded-lg outline-0 pr-2' />
              </div>
        ...
        <div className='w-72 h-max border rounded-xl bg-white'>
          <div className='w-full h-20  border-b flex items-center justify-start pr-6 gap-x-2 '>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M20 4V16H23L19 21L15 16H18V4H20ZM12 18V20H3V18H12ZM14 11V13H3V11H14ZM14 4V6H3V4H14Z" fill="#000"></path></svg>
          <p className='font-bold'>آرشیو بر اساس موضوع</p>
          </div>
          <button onClick={accordionHandler} className=' w-10/12 mx-auto h-10 flex items-center mt-2 justify-between'>
          <p>اقتصاد</p>
          <div>
          {!isShowAccordion && <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"><path d="M11.9997 10.8284L7.04996 15.7782L5.63574 14.364L11.9997 8L18.3637 14.364L16.9495 15.7782L11.9997 10.8284Z" fill="#000"></path></svg>}
          {isShowAccordion && <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"><path d="M11.9997 13.1714L16.9495 8.22168L18.3637 9.63589L11.9997 15.9999L5.63574 9.63589L7.04996 8.22168L11.9997 13.1714Z" fill="#000"></path></svg>}
          </div>
          
          </button>
          {isShowAccordion && <div className='w-10/12 mx-auto my-4 pb-4 flex flex-col gap-y-8 font-bold  border-b'>
          <div className='flex items-center justify-satrt  gap-x-2 '>
              <input type="checkbox" className='w-6 h-6 '/>
              <p>اقتصاد ایران</p>
            </div>
          ...
          <button onClick={accordionHandler2} className=' w-10/12 mx-auto h-10 flex items-center my-2 justify-between'>
          <p>دشمن شناسی</p>
          <div>
          {!isShowAccordion2 && <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"><path d="M11.9997 10.8284L7.04996 15.7782L5.63574 14.364L11.9997 8L18.3637 14.364L16.9495 15.7782L11.9997 10.8284Z" fill="#000"></path></svg>}
          {isShowAccordion2 && <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"><path d="M11.9997 13.1714L16.9495 8.22168L18.3637 9.63589L11.9997 15.9999L5.63574 9.63589L7.04996 8.22168L11.9997 13.1714Z" fill="#000"></path></svg>}
          </div>
          
          </button>
          {isShowAccordion2 && <div className='w-10/12 mx-auto pb-4 flex mt-4 flex-col gap-y-8 font-bold  border-b'>
          <div className='flex items-center justify-satrt  gap-x-2 '>
              <input type="checkbox" className='w-6 h-6 '/>
              <p>اقتصاد ایران</p>
            </div>
          ...
          <button onClick={accordionHandler3} className=' w-10/12 mx-auto h-10 flex items-center my-4 justify-between'>
          <p> امنیت ایران</p>
          <div>
          {!isShowAccordion3 && <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"><path d="M11.9997 10.8284L7.04996 15.7782L5.63574 14.364L11.9997 8L18.3637 14.364L16.9495 15.7782L11.9997 10.8284Z" fill="#000"></path></svg>}
          {isShowAccordion3 && <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"><path d="M11.9997 13.1714L16.9495 8.22168L18.3637 9.63589L11.9997 15.9999L5.63574 9.63589L7.04996 8.22168L11.9997 13.1714Z" fill="#000"></path></svg>}
          </div>
          
          </button>
          {isShowAccordion3 && <div className='w-10/12 mx-auto pb-4 mt-4 flex flex-col gap-y-8 font-bold  border-b'>
          <div className='flex items-center justify-satrt  gap-x-2 '>
              <input type="checkbox" className='w-6 h-6 '/>
              <p>اقتصاد ایران</p>
            </div>
