...
export default function Multimedia(datas) {
  ...
  return (
    <div className=" bg-neutral-100 flex flex-col h-max py-10 w-full mt-4 gap-x-1 ">
      <Boxgradiant />
      <div className="hidden  sm:flex  md:flex justify-evenly container sm:px-2 mx-auto sm:justify-between sm:gap-x-0 gap-6">
        <Aside />
...
export async function getStaticProps(context) {
  const res = await fetch(
    'https://nativecontent.sirafgroup.com/api/v1/portal/contentByPortal/?portalId=1&count=5'
  );
