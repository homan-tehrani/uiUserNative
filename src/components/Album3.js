  ...
  return (
    <div className="bg-gray-800 pt-16 md:pt-12 pb-8 mb-16  px-2 ">
        ...
        <div  className='flex -translate-y-3 sm:translate-y-8 lg:translate-x-40 w-full items-center justify-center  gap-x-1 h-8   text-xsm text-white  px-1 rounded-sm'>
         ...
         <Link href="http://www.youtube.com" className='flex items-center justify-center gap-x-1 opacity-70 bg-gray-900'> 
         <p>youtube</p>
         ...
         <Link href="http://www.twitter.com" className='flex items-center justify-center gap-x-1 bg-slate-700 p-1 rounded-md'> 
         <p>twitter</p>
