          ...
          {albumPhotos1.map((item) => (
            ...
            >
              ...
              >
                ...
                <div
                  dir="rtl"
                  className="bg-neutral-100 flex flex-col w-full h-44 justify-between py-2 p-2 opacity-70"
                >
