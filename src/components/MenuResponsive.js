...
export default function MenuResponsive() {
  return (
    <div className='xs:w-64 w-96 z-50 bg-stone-100 h-[530px] overflow-auto absolute right-4 top-[50px] flex flex-col items-start '>
  ...
  >
    ...
    <ul className='bg-green-200 border-y py-6 w-11/12 mx-auto my-8 flex items-start justify-center gap-y-10 flex-col'>
